  ...
  const submitProduct = async (event) => {
    ...
    try {
      await onSave({
        ...
        codCharge: sellerShippingMode === "self" && form.shippingIncludedInPrice ? 0 : Number(form.codCharge || 0),
