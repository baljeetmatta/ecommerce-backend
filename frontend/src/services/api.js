...
export const api = withActionNotifications({
  ...
  changeAdminPassword: (payload) => request("/auth/me/password", { method: "PUT", body: JSON.stringify(payload) }),
  changeCustomerPassword: (payload) => customerRequest("/auth/customer/password", { method: "PUT", body: JSON.stringify(payload) }),
