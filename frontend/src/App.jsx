...
const bannerSizeLabel = (width, height) => `__banner_size__:${width || ""}x${height || ""}`;
...
function Team({ mode = "access", onAdd, onBack, onManageAccess }) {
