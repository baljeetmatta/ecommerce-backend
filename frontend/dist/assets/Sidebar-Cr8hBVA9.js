import{c as t,j as e,X as o,F as h,S as p}from"./index-yCkTUJfv.js";import{C as k,B as i,M as y}from"./megaphone-C3IYwXLa.js";import{P as m,S as b}from"./store-CnWLG0Pf.js";import{S as x}from"./shield-check-BF_oB82o.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=t("UsersRound",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),v=[{id:"analytics",label:"Analytics",icon:k},{id:"catalog",label:"Catalog",icon:i},{id:"add-product",label:"Add Product",icon:j},{id:"orders",label:"Orders",icon:m},{id:"customers",label:"Customers",icon:S},{id:"partners",label:"Partners",icon:g},{id:"sellers",label:"Sellers",icon:b},{id:"seller-products",label:"Seller Products",icon:i},{id:"banners",label:"Banners",icon:M},{id:"blog",label:"Blog",icon:u},{id:"pages",label:"Pages",icon:h},{id:"footer",label:"Footer",icon:f},{id:"marketing",label:"Marketing",icon:y},{id:"team",label:"Access",icon:x},{id:"settings-payments",label:"Settings",icon:p}];function C({active:n,onChange:l,open:r=!1,onClose:s,settings:d={}}){return e.jsxs("aside",{className:`sidebar ${r?"mobileOpen":""}`,children:[e.jsx("button",{className:"sidebarClose",type:"button",onClick:s,"aria-label":"Close admin menu",children:e.jsx(o,{size:22})}),e.jsxs("div",{className:"brand sidebarTextBrand",children:[e.jsx("strong",{children:d.shopName||"HRS Basket"}),e.jsx("span",{children:"ADMIN CONSOLE"})]}),e.jsx("p",{className:"navCaption",children:"MANAGEMENT"}),e.jsx("nav",{children:v.map(a=>{const c=a.icon;return e.jsxs("button",{type:"button",className:n===a.id||a.id==="settings-payments"&&n.startsWith("settings-")||a.id==="partners"&&n.startsWith("partner-")?"navItem active":"navItem",onClick:()=>{l(a.id),s==null||s()},title:a.label,children:[e.jsx(c,{size:18}),e.jsx("span",{children:a.label})]},a.id)})})]})}export{C as default};
