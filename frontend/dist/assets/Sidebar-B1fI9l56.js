import{c as t,j as e,X as o,F as h,S as p,b as k}from"./index-CrqbeUco.js";import{C as y,B as i,M as b}from"./megaphone-CuFh8U6Y.js";import{P as m,S as x}from"./store-DeNNGYXn.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=t("PanelBottom",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 15h18",key:"5xshup"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=t("SquarePlus",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M8 12h8",key:"1wcyev"}],["path",{d:"M12 8v8",key:"napkw2"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=t("UsersRound",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),S=[{id:"analytics",label:"Analytics",icon:y},{id:"catalog",label:"Catalog",icon:i},{id:"add-product",label:"Add Product",icon:f},{id:"orders",label:"Orders",icon:m},{id:"customers",label:"Customers",icon:v},{id:"partners",label:"Partners",icon:g},{id:"sellers",label:"Sellers",icon:x},{id:"seller-products",label:"Seller Products",icon:i},{id:"banners",label:"Banners",icon:M},{id:"blog",label:"Blog",icon:u},{id:"pages",label:"Pages",icon:h},{id:"footer",label:"Footer",icon:j},{id:"marketing",label:"Marketing",icon:b},{id:"team",label:"Access",icon:p},{id:"settings-payments",label:"Settings",icon:k}];function w({active:n,onChange:l,open:r=!1,onClose:s,settings:d={}}){return e.jsxs("aside",{className:`sidebar ${r?"mobileOpen":""}`,children:[e.jsx("button",{className:"sidebarClose",type:"button",onClick:s,"aria-label":"Close admin menu",children:e.jsx(o,{size:22})}),e.jsxs("div",{className:"brand sidebarTextBrand",children:[e.jsx("strong",{children:d.shopName||"HRS Basket"}),e.jsx("span",{children:"ADMIN CONSOLE"})]}),e.jsx("p",{className:"navCaption",children:"MANAGEMENT"}),e.jsx("nav",{children:S.map(a=>{const c=a.icon;return e.jsxs("button",{type:"button",className:n===a.id||a.id==="settings-payments"&&n.startsWith("settings-")||a.id==="partners"&&n.startsWith("partner-")?"navItem active":"navItem",onClick:()=>{l(a.id),s==null||s()},title:a.label,children:[e.jsx(c,{size:18}),e.jsx("span",{children:a.label})]},a.id)})})]})}export{w as default};
