import{c as l,r as c,j as s,X as g,H as M,F as S,b as j,S as w}from"./index-oM2VZEm5.js";import{L as v,B as h,M as C,C as N}from"./megaphone-GkDtziWR.js";import{S as p,P}from"./store-BaQWDR8u.js";import{C as B}from"./chevron-down-L3mfNnMo.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b=l("UsersRound",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),k=[{label:"Overview",items:[{id:"dashboard",label:"Dashboard",icon:v}]},{label:"Master",items:[{id:"customers",label:"Customers",icon:b},{id:"partners",label:"Partners",icon:I},{id:"sellers",label:"Sellers",icon:p},{id:"staff",label:"Staff",icon:b}]},{label:"Catalog",items:[{id:"catalog",label:"Products",icon:h},{id:"add-product",label:"Add Product",icon:T},{id:"seller-products",label:"Seller Products",icon:h}]},{label:"Operations",items:[{id:"orders",label:"Orders",icon:P},{id:"returns-refunds",label:"Returns & Refunds",icon:E},{id:"seller-withdrawals",label:"Seller Withdrawals",icon:p},{id:"support-tickets",label:"Support Tickets",icon:M}]},{label:"Site",items:[{id:"blog",label:"Blog",icon:R},{id:"banners",label:"Banners",icon:O},{id:"pages",label:"Pages",icon:S},{id:"footer",label:"Footer",icon:L},{id:"marketing",label:"Marketing",icon:C},{id:"settings-payments",label:"Settings",icon:j},{id:"team",label:"Access",icon:w}]},{label:"Reporting",items:[{id:"analytics",label:"Analytics",icon:N}]}];function z({active:n,onChange:m,open:u=!1,onClose:i,settings:y={}}){const d=e=>{var t;return(t=k.find(a=>a.items.some(r=>r.id===e||r.id==="staff"&&e==="create-staff"||r.id==="settings-payments"&&e.startsWith("settings-")||r.id==="partners"&&e.startsWith("partner-"))))==null?void 0:t.label},[x,o]=c.useState(()=>new Set([d(n)||"Master"]));c.useEffect(()=>{const e=d(n);e&&o(t=>new Set([...t,e]))},[n]);const f=e=>o(t=>{const a=new Set(t);return a.has(e)?a.delete(e):a.add(e),a});return s.jsxs("aside",{className:`sidebar ${u?"mobileOpen":""}`,children:[s.jsx("button",{className:"sidebarClose",type:"button",onClick:i,"aria-label":"Close admin menu",children:s.jsx(g,{size:22})}),s.jsxs("div",{className:"brand sidebarTextBrand",children:[s.jsx("strong",{children:y.shopName||"HRS Basket"}),s.jsx("span",{children:"ADMIN CONSOLE"})]}),s.jsx("nav",{children:k.map(e=>{const t=x.has(e.label);return s.jsxs("section",{className:"navGroup",children:[s.jsxs("button",{className:"navGroupToggle",type:"button",onClick:()=>f(e.label),"aria-expanded":t,children:[s.jsx("span",{children:e.label}),s.jsx(B,{size:17,className:t?"expanded":""})]}),t&&s.jsx("div",{className:"navGroupItems",children:e.items.map(a=>{const r=a.icon;return s.jsxs("button",{type:"button",className:n===a.id||a.id==="staff"&&n==="create-staff"||a.id==="settings-payments"&&n.startsWith("settings-")||a.id==="partners"&&n.startsWith("partner-")?"navItem active":"navItem",onClick:()=>{m(a.id),i==null||i()},title:a.label,children:[s.jsx(r,{size:18}),s.jsx("span",{children:a.label})]},a.id)})})]},e.label)})})]})}export{z as default};
