import{c as r,r as c,j as s,X as f,H as g,F as j,b as S,S as M}from"./index-BR6ac_NT.js";import{S as v,P as w}from"./store-CAR3ZIPr.js";import{B as p,M as N,C as P}from"./megaphone-CHTFX5Cn.js";import{C as B}from"./chevron-down-CrYZ3W-b.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h=r("UsersRound",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),b=[{label:"Master",items:[{id:"customers",label:"Customers",icon:h},{id:"partners",label:"Partners",icon:I},{id:"sellers",label:"Sellers",icon:v},{id:"staff",label:"Staff",icon:h}]},{label:"Catalog",items:[{id:"catalog",label:"Products",icon:p},{id:"add-product",label:"Add Product",icon:R},{id:"seller-products",label:"Seller Products",icon:p}]},{label:"Operations",items:[{id:"orders",label:"Orders",icon:w},{id:"support-tickets",label:"Support Tickets",icon:g}]},{label:"Site",items:[{id:"blog",label:"Blog",icon:C},{id:"banners",label:"Banners",icon:O},{id:"pages",label:"Pages",icon:j},{id:"footer",label:"Footer",icon:E},{id:"marketing",label:"Marketing",icon:N},{id:"settings-payments",label:"Settings",icon:S},{id:"team",label:"Access",icon:M}]},{label:"Reporting",items:[{id:"analytics",label:"Analytics",icon:P}]}];function z({active:n,onChange:m,open:k=!1,onClose:i,settings:x={}}){const d=e=>{var t;return(t=b.find(a=>a.items.some(l=>l.id===e||l.id==="staff"&&e==="create-staff"||l.id==="settings-payments"&&e.startsWith("settings-")||l.id==="partners"&&e.startsWith("partner-"))))==null?void 0:t.label},[y,o]=c.useState(()=>new Set([d(n)||"Master"]));c.useEffect(()=>{const e=d(n);e&&o(t=>new Set([...t,e]))},[n]);const u=e=>o(t=>{const a=new Set(t);return a.has(e)?a.delete(e):a.add(e),a});return s.jsxs("aside",{className:`sidebar ${k?"mobileOpen":""}`,children:[s.jsx("button",{className:"sidebarClose",type:"button",onClick:i,"aria-label":"Close admin menu",children:s.jsx(f,{size:22})}),s.jsxs("div",{className:"brand sidebarTextBrand",children:[s.jsx("strong",{children:x.shopName||"HRS Basket"}),s.jsx("span",{children:"ADMIN CONSOLE"})]}),s.jsx("nav",{children:b.map(e=>{const t=y.has(e.label);return s.jsxs("section",{className:"navGroup",children:[s.jsxs("button",{className:"navGroupToggle",type:"button",onClick:()=>u(e.label),"aria-expanded":t,children:[s.jsx("span",{children:e.label}),s.jsx(B,{size:17,className:t?"expanded":""})]}),t&&s.jsx("div",{className:"navGroupItems",children:e.items.map(a=>{const l=a.icon;return s.jsxs("button",{type:"button",className:n===a.id||a.id==="staff"&&n==="create-staff"||a.id==="settings-payments"&&n.startsWith("settings-")||a.id==="partners"&&n.startsWith("partner-")?"navItem active":"navItem",onClick:()=>{m(a.id),i==null||i()},title:a.label,children:[s.jsx(l,{size:18}),s.jsx("span",{children:a.label})]},a.id)})})]},e.label)})})]})}export{z as default};
