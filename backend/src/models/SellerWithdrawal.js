...
const sellerWithdrawalSchema = new mongoose.Schema(
  {
    ...
    bankSnapshot: { accountType: String, accountNumber: String, ifsc: String, bankName: String, branch: String, accountHolderName: String, upiId: String, upiDisplayName: String },
    adminNote: String,
    paidAt: Date,
    processedAt: Date,
