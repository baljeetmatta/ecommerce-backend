...
router.post("/admin/withdrawals/:id/payout/status", protect, refreshSellerPayoutStatus);
router.get("/admin/balance-collections", protect, authorize("Super Admin", "Team Leader", "Staff"), listSellerBalanceCollections);
router.post("/admin/balance-collections/:id", protect, authorize("Super Admin", "Team Leader", "Staff"), collectSellerBalance);
