import{c as t,j as e,X as c}from"./index-tROwIn_v.js";import{C as h,B as i,M as p}from"./megaphone-DE75YvIL.js";import{F as k,S as y}from"./App-DZp1eIrS.js";import{P as m}from"./package-check-CZPHFrdK.js";import{S as b}from"./shield-check-D6w7IW6v.js";import{S as x}from"./store-CIiCrWH7.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=t("UsersRound",[["path",{d:"M18 21a8 8 0 0 0-16 0",key:"3ypg7q"}],["circle",{cx:"10",cy:"8",r:"5",key:"o932ke"}],["path",{d:"M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3",key:"10s06x"}]]),v=[{id:"analytics",label:"Analytics",icon:h},{id:"catalog",label:"Catalog",icon:i},{id:"add-product",label:"Add Product",icon:j},{id:"orders",label:"Orders",icon:m},{id:"customers",label:"Customers",icon:S},{id:"partners",label:"Partners",icon:g},{id:"sellers",label:"Sellers",icon:x},{id:"seller-products",label:"Seller Products",icon:i},{id:"banners",label:"Banners",icon:M},{id:"blog",label:"Blog",icon:u},{id:"pages",label:"Pages",icon:k},{id:"footer",label:"Footer",icon:f},{id:"marketing",label:"Marketing",icon:p},{id:"team",label:"Access",icon:b},{id:"settings-payments",label:"Settings",icon:y}];function A({active:r,onChange:n,open:l=!1,onClose:s,settings:d={}}){return e.jsxs("aside",{className:`sidebar ${l?"mobileOpen":""}`,children:[e.jsx("button",{className:"sidebarClose",type:"button",onClick:s,"aria-label":"Close admin menu",children:e.jsx(c,{size:22})}),e.jsxs("div",{className:"brand sidebarTextBrand",children:[e.jsx("strong",{children:d.shopName||"HRS Basket"}),e.jsx("span",{children:"ADMIN CONSOLE"})]}),e.jsx("p",{className:"navCaption",children:"MANAGEMENT"}),e.jsx("nav",{children:v.map(a=>{const o=a.icon;return e.jsxs("button",{type:"button",className:r===a.id||a.id==="settings-payments"&&r.startsWith("settings-")||a.id==="partners"&&r.startsWith("partner-")?"navItem active":"navItem",onClick:()=>{n(a.id),s==null||s()},title:a.label,children:[e.jsx(o,{size:18}),e.jsx("span",{children:a.label})]},a.id)})})]})}export{A as default};
